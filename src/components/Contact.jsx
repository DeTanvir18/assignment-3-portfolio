    ...
    return (
        <div id="Contact" className="p-4 lg:p-20 flex flex-col justify-center items-center">
            ...
            <form onSubmit={handleContact} method="POST" data-netlify="true" action="" className="flex flex-col gap-2 lg:w-1/2 text-white">
                ...
                <textarea className="w-full my-3 rounded-lg bg-slate-800 p-4 border-2 border-sky-400 text-xl" placeholder="Your Message Here..." name="" id="" cols="20" rows="4"></textarea>
                <input className="neno-button shadow-xl hover:shadow  border border-sky-700 bg-sky-500 hover:bg-slate-800 rounded-lg py-4 px-8 my-2 uppercase relative overflow-hidden text-xl font-bold mb-10" type="submit" value="Submit" />
            </form>
        </div>
    );
};
